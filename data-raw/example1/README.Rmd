...
|-----------|:-----------------------:|---------:|-------------------------------------------:|
| Iterative |  `MLML` (`tol=0.00001`) | `MLML2R` | `r round(mbm$time[mbm$expr=="EM"]/(1e9),3)`  |
| Iterative |  `fitOxBS`              | `OxyBS`  | `r round(mbm$time[mbm$expr=="oxyBS_res"]/(1e9),3)`  |
| Closed-form analytical |  `MLML` (`exact=TRUE`) | `MLML2R` | `r round(mbm$time[mbm$expr=="EXACT"]/(1e9),3)`  |
