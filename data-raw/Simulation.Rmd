...
aa <- max(c(MAE_result1[,1],MAE_result2[,1],MAE_result3[,1],MAE_result4[,1]),na.rm=TRUE)
...
lines(x=coverage,y=as.vector(MAE_result1[,1]),col=2)
```
```{r,echo=FALSE}
T.matrix = MethylatedBS; U.matrix = UnMethylatedBS; L.matrix = UnMethylatedOxBS; M.matrix = MethylatedOxBS
