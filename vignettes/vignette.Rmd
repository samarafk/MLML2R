...
We notice a problematic sample: GSM1833667. This sample and its corresponding pair in the TAB experiment, GSM1833691, were removed from subsequent analysis.
...
MethylatedBS    <- do.call(cbind,lapply(files,function(fn) 
...
MethylatedOxBS    <- do.call(cbind,lapply(files,function(fn) 
  fread(fn,data.table=FALSE,select=c("methylated_read_count"))))
...
Tm = as.matrix(MethylatedBS)
Um = as.matrix(UnMethylatedBS)
Lm = as.matrix(UnMethylatedOxBS)
Mm = as.matrix(MethylatedOxBS)
```
