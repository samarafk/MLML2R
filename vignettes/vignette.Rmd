...
pD$method <- sapply(pD$source_name_ch1,function(x) 
  strsplit(as.character(x),",")[[1]][3]) 
pD$group <- sapply(pD$source_name_ch1,function(x) 
...
The input in the \Rfunction{MLML} function accepts as input a \Rclass{MethylSet}, which contains the methylated and unmethylated signals. We chose the function \Rfunction{preprocessNoob} [@noob] for background correction, dye-bias normalization and construction of the \Rclass{MethylSet}.
