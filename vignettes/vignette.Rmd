...
```{r,eval=FALSE,echo=FALSE}
save(MethylatedBS,UnMethylatedBS,MethylatedTAB,UnMethylatedTAB,file="data_processed1.rds")

# Naive estimates
beta_BS <- getBeta(MSet.noob)[,BSindex]
beta_TAB <- getBeta(MSet.noob)[,TABindex]
hmC_naive <- beta_TAB #5-hmC naive estimate
C_naive <- 1-beta_BS #5-C naive estimate
mC_naive <- beta_BS-beta_TAB #5-mC naive estimate
save(hmC_naive,mC_naive,C_naive,beta_BS,beta_TAB,file="naive2.rds")
```
